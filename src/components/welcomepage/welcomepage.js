  ...
  return (
    <div>
      <div className="welcome-container">
        ...
        <div className="welcome-paragraph">
          <Typed
            ...
            strings={[
              "Find your top songs. At any time.",
              "Make an awesome playlist.",
              "Welcome to Preferify.",
            ]}
            typeSpeed={40}
          />
          <p1 className="welcome-para-subtext header-sub">
            A place for all your favorite Spotify songs.
          </p1>
        </div>
      ...
      <div className="otherinfo-container">
        ...
        <div className="ipad-div" data-aos="fade-up">
          <div className="vert-flex">
            ...
            <p1 className="welcome-para-subtext">
              {" "}
              Preferify uses Spotify's official API to find your most listened
              to songs.
            </p1>
          </div>
        ...
        <div className="other-div" data-aos="fade-up">
          ...
          <p1 className="welcome-para-subtext">
            Transform your most listened to songs into a playlist with the touch
            of a button.
          </p1>
      ...
      <div className="github-info">
        <a className="creator" href={"mailto:kinjalkbajpai@gmail.com"}>
          Created by Kinjalk
        </a>
      </div>
    </div>
